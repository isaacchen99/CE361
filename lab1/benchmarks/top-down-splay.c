/*
 From: https://www.link.cs.cmu.edu/splay/download/top-down-splay.c
...
/* insert some stuff into it, and then delete */
	...
	root = insert((7919*i) & (65535), root);
    }
    print(root);
    for (int i = 0; i < count; i++) {
	root = delete((7919*i) & (65535), root);
    }
    printf("size = %d\n", size);
}
